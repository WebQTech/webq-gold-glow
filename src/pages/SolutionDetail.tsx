...
import { ArrowRight, Check, Building2, ChevronRight, Home } from "lucide-react";
        ...
        <section ref={heroRef} className="py-10 lg:py-16 bg-gradient-to-b from-primary/5 to-background">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <span className="text-base font-black tracking-widest text-primary uppercase">Solution</span>
        ...
        <section ref={featuresRef} className="py-10 lg:py-16">
          <div className="container mx-auto px-6 lg:px-12">
            <div className="grid lg:grid-cols-2 gap-12">
              ...
              >
                <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-6">What We Deliver</h2>
              ...
              >
                <h2 className="text-2xl lg:text-3xl font-bold text-foreground mb-6">Key Benefits</h2>
                <ul className="space-y-4">
