...
export const technologiesData: TechnologyDetail[] = [
  // ── AI & Machine Learning (highest demand first) ──
  {
    slug: "openai",
    name: "OpenAI",
  ...
  },
  {
    ...
    category: "AI & Machine Learning",
    icon: Sparkles,
    shortDescription: "Google's multimodal AI platform for text, image, and code.",
    fullDescription: "Google Gemini delivers state-of-the-art multimodal AI capabilities spanning text, images, audio, video, and code understanding in a single unified model. We integrate Gemini Pro, Flash, and Ultra across enterprise applications for intelligent document processing, visual analysis, and conversational AI. For businesses, Gemini's native multimodal design eliminates the need to chain separate models together, reducing latency and complexity while improving accuracy on tasks that span multiple data types. Its massive context window enables processing of entire codebases, lengthy documents, and complex datasets in a single prompt. Deep integration with Google Cloud and Vertex AI provides enterprise-grade deployment, monitoring, and governance. Gemini's competitive pricing and tiered model offerings let organizations balance cost and capability. We leverage Gemini's advanced reasoning and multimodal capabilities to build intelligent applications that understand context across formats — delivering AI solutions that see, read, and reason like domain\u00A0experts.",
    useCases: ["Multimodal AI Applications", "Document Understanding", "Code Analysis", "Visual Q&A", "Enterprise Chatbots"],
    features: ["Multimodal understanding", "Large context window", "Gemini Pro/Flash/Ultra tiers", "Vertex AI integration", "Function calling"],
    relatedTechnologies: ["Vertex AI", "LangChain", "Python", "GCP"],
  },
  {
    slug: "langchain",
    name: "LangChain",
  ...
  },
  {
    ...
    category: "AI & Machine Learning",
    icon: Flame,
    shortDescription: "Dynamic deep learning framework preferred by researchers.",
    fullDescription: "PyTorch has become the dominant deep learning framework for research and production, powering breakthroughs in computer vision, NLP, and generative AI. We use it for custom model development, transfer learning, and deploying inference services that require the latest AI research capabilities. For businesses, PyTorch's dynamic computation graph enables rapid prototyping and experimentation, reducing the time from research idea to production deployment. Its TorchServe framework provides scalable model serving with batching, model versioning, and A/B testing. The Hugging Face ecosystem builds extensively on PyTorch, providing access to hundreds of thousands of pre-trained models. Companies like Meta, Tesla, and OpenAI chose PyTorch for their most critical AI systems. We leverage AI-accelerated training pipelines, automated model optimization, and intelligent distributed training to deliver state-of-the-art deep learning models — transforming cutting-edge research into production-ready business\u00A0solutions.",
    useCases: ["Custom Model Training", "Computer Vision", "NLP & LLMs", "Generative AI", "Reinforcement Learning"],
    features: ["Dynamic computation graph", "TorchServe for serving", "Distributed training", "ONNX export", "Extensive model zoo"],
    relatedTechnologies: ["Python", "Hugging Face", "CUDA"],
  },
  {
    slug: "aws-sagemaker",
    name: "AWS SageMaker",
    category: "AI & Machine Learning",
    icon: CloudLightning,
    shortDescription: "Amazon's fully managed ML platform for training and deployment.",
    fullDescription: "AWS SageMaker provides end-to-end machine learning lifecycle management with managed notebooks, distributed training, automatic model tuning, and one-click deployment — all deeply integrated with the AWS ecosystem. For businesses, SageMaker eliminates the undifferentiated heavy lifting of ML infrastructure, allowing data science teams to focus on model accuracy and business impact rather than server management. Its built-in algorithms and AutoML capabilities enable teams without deep ML expertise to build production-quality models. SageMaker Pipelines provides CI/CD for ML, ensuring reproducible and auditable model training. Ground Truth manages data labeling at scale with human-in-the-loop workflows. Model Monitor detects data drift and model degradation in real-time. We leverage SageMaker's managed infrastructure with AI-powered experiment tracking and intelligent cost optimization to deliver enterprise MLOps — from rapid prototyping to production deployment at\u00A0scale.",
    useCases: ["MLOps Automation", "Model Training at Scale", "Real-time Inference", "Batch Predictions", "AutoML"],
    features: ["Managed notebooks", "Distributed training", "AutoML (Autopilot)", "Model Monitor", "SageMaker Pipelines"],
    relatedTechnologies: ["AWS", "Python", "PyTorch", "TensorFlow"],
  },
  {
    slug: "azure-ai",
    name: "Azure AI / Azure OpenAI",
    category: "AI & Machine Learning",
    icon: CloudCog,
    shortDescription: "Microsoft's enterprise AI platform with OpenAI integration.",
    fullDescription: "Azure AI provides enterprise-grade AI services including Azure OpenAI Service, Cognitive Services, and Azure Machine Learning — enabling organizations to deploy GPT-4, DALL·E, and custom models within their own Azure tenant with full data privacy and compliance controls. For businesses, Azure OpenAI delivers the power of OpenAI models with enterprise security features including virtual network isolation, managed identity authentication, and content filtering — critical for regulated industries. Azure Cognitive Services offer ready-to-use AI capabilities for vision, speech, language, and decision-making without ML expertise. Azure Machine Learning provides comprehensive MLOps with automated ML, responsible AI dashboards, and model interpretability. Integration with Microsoft 365 and Dynamics 365 embeds AI directly into existing business workflows. We leverage Azure AI to build compliant, secure AI solutions that operate within enterprise governance frameworks — delivering transformative intelligence without compromising data sovereignty or regulatory\u00A0obligations.",
    useCases: ["Enterprise GPT Deployments", "Document Intelligence", "Speech & Translation", "Custom Vision Models", "Responsible AI"],
    features: ["Azure OpenAI Service", "Cognitive Services", "Azure ML Studio", "Content Safety", "Private endpoints"],
    relatedTechnologies: ["Microsoft Azure", "OpenAI", "Python", ".NET"],
  },
  {
    slug: "tensorflow",
    name: "TensorFlow",
  ...
  // ── Cloud Platforms (highest demand first) ──
  {
    slug: "aws",
  ...
  // ── DevOps & CI/CD (highest demand first) ──
  {
    slug: "docker",
    name: "Docker",
  ...
  // ── Databases (highest demand first) ──
  {
    slug: "postgresql",
    name: "PostgreSQL",
    category: "Databases",
  ...
  // ── Enterprise Platforms (highest demand first) ──
  {
    slug: "salesforce",
    name: "Salesforce",
