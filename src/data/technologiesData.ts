...
export const technologiesData: TechnologyDetail[] = [
  ...
  },
  {
    ...
    fullDescription: "AWS SageMaker provides a complete MLOps platform for building, training, and deploying machine learning models at scale with fully managed infrastructure. We use SageMaker for enterprise ML workflows that require robust experiment tracking, automated model tuning, and production-grade inference endpoints. For businesses, SageMaker eliminates the undifferentiated heavy lifting of ML infrastructure — from notebook-based experimentation to one-click model deployment with auto-scaling. Its built-in algorithms and pre-trained models accelerate time-to-value, while SageMaker Pipelines automate end-to-end ML workflows with full reproducibility. Ground Truth provides cost-effective data labeling, and Model Monitor detects data drift in production. Deep integration with the AWS ecosystem enables seamless data access from S3, Redshift, and Athena. We leverage SageMaker's managed infrastructure, automated tuning, and intelligent monitoring to deliver scalable ML solutions — reducing operational complexity while maximizing model accuracy and business\u00A0impact.",
    useCases: ["ML Model Training", "Automated Model Tuning", "Real-time Inference", "Batch Predictions", "MLOps Pipelines"],
    features: ["Managed Jupyter notebooks", "Built-in algorithms", "SageMaker Pipelines", "Model Monitor", "Ground Truth labeling"],
    relatedTechnologies: ["AWS", "Python", "TensorFlow", "PyTorch"],
  },
  {
    slug: "azure-ai",
    ...
    category: "AI & Machine Learning",
    icon: CloudCog,
    shortDescription: "Microsoft's enterprise AI services with OpenAI integration.",
    fullDescription: "Azure AI combines Microsoft's Cognitive Services, Azure Machine Learning, and the exclusive Azure OpenAI Service to deliver enterprise-grade AI with unmatched security, compliance, and integration capabilities. We use Azure AI for organizations requiring GPT-4 and DALL·E within their own Azure tenant — ensuring data residency, network isolation, and regulatory compliance that direct API access cannot provide. For businesses, Azure OpenAI Service delivers the same powerful models with enterprise controls including content filtering, rate limiting, and private endpoints. Azure Cognitive Services provide ready-to-use vision, speech, language, and decision APIs that accelerate AI adoption without ML expertise. Azure Machine Learning offers a full MLOps platform with automated ML, responsible AI dashboards, and managed endpoints. We leverage Azure AI's enterprise security model and deep Microsoft ecosystem integration to deliver compliant, production-ready AI solutions — enabling organizations in regulated industries to harness generative AI with\u00A0confidence.",
    useCases: ["Enterprise GPT Applications", "Cognitive Services Integration", "Compliant AI Deployments", "Azure ML Pipelines", "AI-powered Document Processing"],
    features: ["Azure OpenAI Service", "Cognitive Services", "Azure Machine Learning", "Responsible AI tools", "Private endpoints"],
