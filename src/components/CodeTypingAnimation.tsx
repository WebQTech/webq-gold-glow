    ...
    <div className="w-full">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {/* Code area */}
          <div className="p-3 font-mono text-xs leading-relaxed max-h-[340px] overflow-y-auto [&::-webkit-scrollbar]:w-1.5 [&::-webkit-scrollbar-thumb]:bg-[#45475a] [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-transparent">
